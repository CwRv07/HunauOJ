 ...
 * @LastEditTime: 2022-04-28 16:29:32
 * @Description:
...
module.exports = {
  ...
  // 继承共享的配置
  extends: ['vue-global-api', 'plugin:prettier/recommended', 'plugin:vue/vue3-recommended', 'plugin:@typescript-eslint/recommended', '@vue/eslint-config-prettier'],
